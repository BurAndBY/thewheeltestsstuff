(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    ["games/the-wheel"], {
        ...
        21057: (t, s, e) => {
            ...
            const y = {
                    ASK: "СПРОСИТЬ",
                    FILTER_ERROR: "Вы не сможете затролить Колесо этими словами, попробуйте ещё раз другими словами.",
                    NO: "НЕТ",
                    OR: "ИЛИ",
                    SEND: "ПУКНУТЬ",
                    SUBMIT: "ПУКНУТЬ",
                    TRY_AGAIN: "ПОДОЖДИ, ТВАРЬ",
                    UNDO: "ОТМЕНА",
                    YES: "ДА",
                    AUDIENCE: {
                        NAME: "БОТ",
                        VOTE_NOW: "ГОЛОСУЙТЕ СЕЙЧАС",
                        THANKS: ["Вами ботами, гордится весь Китай! Социальный статус ваш повысился, вам даётся тарелка риса и кошко-девочка.", "С каждым твоим нажатием, умирает чья-то лошадь!", "Вы кто такие? Я вас не звал.", "Чел, если бы ты знал что твой голос ничего не значит, ты бы расплакался.", "Вы знали что вы только что нажали на “Отправить свои деньги Колесу”?"]
                    },
                    GUESSING: {
                        BANNER: "ВЫ ДУМАЛИ?",
                        INCORRECT: "НЕ ПРАВИЛЬНО",
                        CORRECT: "ТЫ ПЕРЕИГРАЛ МЕНЯ?!",
                    ...
                    NUMERIC: {
                        BANNER: "ВПИШИ БУКВЫ, ЖИВО!"
                    },
                    PLACE_SLICES: {
                        PLACE: "РАСПОЛОЖИТЕ ВАШИ СЕКТОРЫ",
                        SUBMIT: "ГОТОВО! НАЖМИТЕ ПУКНУТЬ",
                        THANKS: "ХОРОШАЯ РАБОТА, КАМЕНЩИК"
                    },
                    QUESTION: {
                        BANNER: "БЕГИТЕ, ГЛУПЦЫ",
                        PLACEHOLDER: "Напишите ваш безмыслинный вопрос"
                    },
                    RAPID: {
                        BANNER: "Симулятор выбора",
                        CORRECT: "ПРАВИЛЬНО",
                        FROZEN: "ЗАБАНЕН, ЧЕКАЙ"
                    },
                    SPIN: {
                    ...
                    TYPING: {
                        ...
                        SUBJECTIVE_BANNER: "Отгадайте, словно вы блогеры",
                        CORRECT: "ВАУ",
                        TAKEN: "УЖЕ ОТВЕТИЛ",
                        OBJECTIVE_INCORRECT: "НЕА",
                        SUBJECTIVE_INCORRECT: "ВООБЩЕ НЕА",
                        PLACEHOLDER: "Отгадайте"
                    },
                    WAITING: {
                        SPIN: '[player avatar="{avatar}"]{name}[/player] крутит меня',
                        MESSAGES: ["Запомните твари, а то забудете.", "Здесь пустовато. Я опять в твоём мозгу?", "Я выпил таблетку от шизы, но почему ты не пропал?", "Ожидания ожидания, ты ожидаешь ожидание!", "Вы в очереди 512-ый, сейчас только первого обслуживаем!", "Эй, привет красотка! А ой, прости, перепутал тебя со страшной подругой.", "(https://youtu.be/dQw4w9WgXcQ)", "Руки на стол, каменщик. Ты думаешь я ничего не вижу?", "!", ".", "?", "Здесь могла быть ваша реклама.", "Хватит пялиться, я стесняюсь.", "После этой игры, все проигравшие пересказывают мне Войну и мир.", "Колесо Ненормального Троллинга купил тебя", "Здесь была твоя мамка"]
                    },
                    ARIA: {
                        ANSWER: "сектор ответа.",
                        AUDIENCE: "сектор ботов.",
                        BAD: "сектор тролля.",
                        BONUS: "сектор силы для {for}.",
                        EMPTY: "пусто.",
                        MULTIPLIER: "пустой {multiplier}x множитель.",
                        NEIGHBOR: "сектор соседа.",
                        PLAYER: "сектор игрока для {for}.",
                        POINTS: "{slice.data.points} очков сектора.",
                        POINTS_FOR: "очков сектора для {for}.",
                        RESERVED: "зарезервировано для {for}.",
                        WINNER: "сектор победителя для {for}.",
                        KEEP_GOING: "продолжи.",
                        SPIN_POWER: "{power} процентов силы вращения.",
                        SPIN: "проводите вниз или быстро жмите для вращения",
                        SLICE_COUNT: "у тебя есть 0 секторов. | у тебя есть 1 сектор. | у тебя есть {count} сектора(ов).",
                        YOU_CAN_WIN: "Теперь у вас достаточно очков для победы.",
                        YOUR_AVATAR: "Ваш персонаж это:",
                        PLAYER1: "Солдат",
                        PLAYER2: "Губка Боб",
                        PLAYER3: "Зомби",
                        PLAYER4: "Стив",
                        PLAYER5: "Танос",
                        PLAYER6: "Даша-путешественница",
                        PLAYER7: "Шрек",
                        PLAYER8: "Санс"
                    }
                },
            ...
            var W = function() {
                ...
                return e("button", {
                    ...
                    attrs: {
                        d: "m 158.78348,100.66531 c -1.41813,-0.83213 -2.80018,-1.733639 -4.1544,-2.696904 -0.77522,-0.189822 -1.55043,-0.384704 -2.32575,-0.584252 0.17484,-0.873885 0.38027,-1.743418 0.61681,-2.608557 0.74941,-0.94345 1.54361,-1.857381 2.38665,-2.740284 -2.78588,-0.599869 -5.58311,-1.191063 -8.39162,-1.767909 0.31328,1.61215 0.68145,3.191213 1.1126,4.73517 -0.46934,3.66971 -0.51587,7.347336 -0.14246,11.032816 -0.63605,1.53323 -1.21303,3.11273 -1.74123,4.73476 3.3443,-0.16799 6.69298,-0.40365 10.04572,-0.71541 1.29737,-0.60613 2.59189,-1.19243 3.88494,-1.75567 0.19019,-1.28125 0.45223,-2.52491 0.79267,-3.72934 -0.80136,-1.25293 -1.4929,-2.55509 -2.08393,-3.90442 z m -2.88395,5.53478 c -0.5788,0.5618 -1.14943,1.14011 -1.71314,1.73395 -0.54501,-0.008 -1.08961,-0.0185 -1.63381,-0.0316 -0.47404,-2.72707 -0.66463,-5.44862 -0.57036,-8.164618 0.70209,0.289118 1.40649,0.569448 2.11355,0.840418 0.84573,1.19126 1.75133,2.33219 2.7255,3.41926 -0.32884,0.71887 -0.63558,1.45326 -0.92174,2.20264 z M 141.12617,92.355088 c -0.50974,0.05417 -1.01895,0.110702 -1.52765,0.169512 -0.38369,4.723721 -0.30786,9.42885 0.24371,14.11518 0.8077,1.52742 1.67448,3.0225 2.60843,4.48289 -2.90509,0.3689 -5.81627,0.71092 -8.73276,1.0244 0.50093,-2.24673 1.05854,-4.45682 1.6883,-6.62609 -0.23858,-4.42815 -0.13347,-8.853064 0.3166,-13.274721 -0.